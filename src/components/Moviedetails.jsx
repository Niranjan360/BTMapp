                ...
                {movie && 
                            <div className="movie-details" ref={cont}>
                                ...
                                <div className="trailer-cont">
                                    ...
                                    <iframe width="560" height="315" src={`${movie.trailerurl}?&autoplay=1`}  title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </div>
